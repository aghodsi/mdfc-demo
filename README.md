...
The goal of this script is to provide a step-by-step guide to perform an attack and demonstrate how; Defender for Cloud, Server and Microsoft Sentinel can detect and alert on these activities.
